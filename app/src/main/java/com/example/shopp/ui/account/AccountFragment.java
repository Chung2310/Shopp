...
public class AccountFragment extends Fragment {
    ...
    public void showDataUser(){
        ...
        String postAvatarUrl = Utils.user.getAvatarUrl().contains("https") ?
                Utils.user.getAvatarUrl() : newUrl + "avatar/" + Utils.user.getAvatarUrl();
        Log.d("AvatarUrl",postAvatarUrl);

        String postBackgroundUrl = Utils.user.getBackgroundUrl().contains("https") ?
    ...
    public void showFullImageDialog(Context context,String mode) {
        String imageUrl;
        if(mode == "avatar") {
            imageUrl = Utils.user.getAvatarUrl();
        }
        else {
            imageUrl = Utils.user.getBackgroundUrl();
        }
