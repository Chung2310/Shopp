package com.example.shopp.ui.admin.product;
...
public class ProductAdminFragment extends Fragment {
    ...
    private ProductAdminViewModel mViewModel;

    public static ProductAdminFragment newInstance() {
        return new ProductAdminFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(ProductAdminViewModel.class);
